export const API_ROUTES = {
    ...
    RESTAURANTS: {
        ...
        MENU_ITEMS: {
            CREATE: (restaurantId: string) => `/restaurants/${restaurantId}/items`,
        ...
        OWNER: {
            GET_ITEM_STATS: (restaurantId: string) => `/restaurants/${restaurantId}/stats`,
            GET_TOP_CUSTOMERS: (restaurantId: string) =>
                `/restaurants/${restaurantId}/top-customers`,
            GET_RESTAURANT_ORDERS: (restaurantId: string) => `/restaurants/${restaurantId}/orders`,
        },
    },
    ORDERS: {
